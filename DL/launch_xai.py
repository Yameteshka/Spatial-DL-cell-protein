...
def _create_bundle(train_script_path: str) -> str:
    ...
    bundle_path = os.path.join(script_dir, "gradcam_v3_bundle.py")
...
EXPERIMENTS = [
    {
        "name": "XAI_v3_heldout_original_style",
        "queue_name": QUEUE,
        "overrides": {
...
def main():
    ...
    for marker in ("class Saliency", "PORTED VERBATIM", "Classic MIP Grad-CAM",
                   "Greys_r", "AOR Area (norm)", "Z-Slices XAI"):
